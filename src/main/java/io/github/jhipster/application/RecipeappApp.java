...
public class RecipeappApp {

    private static final Logger log = LoggerFactory.getLogger(RecipeappApp.class);

    private final Environment env;

    public RecipeappApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RecipeappApp.class);
